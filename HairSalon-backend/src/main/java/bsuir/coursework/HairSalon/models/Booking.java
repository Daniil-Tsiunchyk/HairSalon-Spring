...
public class Booking {
    ...
    @Schema(description = "Unique identifier for the booking", example = "1", hidden = true)
    private int id;
    ...
    @Schema(description = "Date and time of the booking", example = "2023-10-19T14:30:00Z")
