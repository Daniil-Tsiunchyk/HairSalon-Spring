...
@Tag(name = "Discount Cards Service", description = "Operations for interacting with discount services")
public class DiscountCardController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<DiscountCard> getDiscountCardById(
    ...
    public ResponseEntity<DiscountCard> createDiscountCard(
            @RequestBody @Parameter(description = "Discount card data to create") DiscountCard discountCard) {
    ...
    public ResponseEntity<DiscountCard> updateDiscountCard(
            @PathVariable @Parameter(description = "ID of the discount card") int id,
            @RequestBody @Parameter(description = "Updated discount card data") DiscountCard updatedDiscountCard) {
    ...
    public ResponseEntity<DiscountCard> getDiscountCardByUserId(
