...
async function main() {
  const LOCATION = {
    center: [27.610120723557344, 53.884848342819005],
    zoom: 13,
  };
  const LOCATION1 = {
    center: [27.63001000667869, 53.89026017551443],
    zoom: 15,
  };
  const LOCATION2 = {
    center: [27.590916591152947, 53.88133234553783],
    zoom: 15,
  };
  const LOCATION3 = {
    center: [27.58608796178701, 53.89216891552366],
    zoom: 15,
  };
  ...
  ymaps3.ready.then(() => {
    changeCenter1.onclick = function () {
      setCenter(LOCATION1);
    };
    changeCenter2.onclick = function () {
      setCenter(LOCATION2);
    };
    changeCenter3.onclick = function () {
      setCenter(LOCATION3);
    };
    changeCenter4.onclick = function () {
      setCenter(LOCATION4);
    };
  });
}
